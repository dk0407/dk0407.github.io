...
|연번|오브젝트 이름|오브젝트 이미지|
|:---:|:---:|:---:|
|1|큐브|<img src="./img/큐브.jng">|
|2|노트|<img src="./img/노트.png">|
|3|루트|<img src="./img/루트.bmp">|
|4|실버|<img src="./img/실버.jng">|
|5|골드|<img src="./img/골드.jng">|
|6|프리즘|<img src="./img/프리즘.jng">|
|7|피버노트|<img src="./img/피버노트.jng">|
|8|피버루트|<img src="./img/피버루트.jng">|
...
## 2) 보조규칙
총 3번의 기회(하트)가 있으며 노트의 타이밍을 못 맞추거나 놓치게 되면 'dummy'이란 판정이 나와서 하트가 없어집니다 또한 플레이어를 움직이면서 루트에서 떨어질 시 하트가 없어집니다. 하트가 1개씩 없어질 때마다<BR> 콤보 또한 리셋됩니다.
      

# 7. 게임에서 사용될 공식
게임에서 어떤 이벤트가 발생했을 때, <BR>그 결과를 판단하기 위한 계산 공식을 지정
